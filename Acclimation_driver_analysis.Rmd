...
boxplot(acclimation$r3avg[acclimation$r3avg_p < 0.1 | acclimation$r3avg_p < 0.1])
t.test(rs_field$r3[rs_field$result=='YES'], acclimation$r3avg[acclimation$r3avg_p < 0.1])
# t = 0.6894, df = 71.385, p-value = 0.4928
# means(-0.1154954 -0.1301248 )

summary(aov(data=acclimation, r3avg ~ IGBP))
#             Df Sum Sq  Mean Sq F value Pr(>F)
# IGBP         9 0.0818 0.009084   1.427   0.19
# Residuals   83 0.5285 0.006367 

summary(aov(data=acclimation, r3avg ~ Climate_class))
#               Df Sum Sq  Mean Sq F value Pr(>F)  
...
acclimation.use <- read.csv('acclimation_data_clear.csv')
#
# elevation
