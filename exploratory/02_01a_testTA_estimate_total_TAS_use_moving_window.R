...
# Step 2: for a specific year, do we have enough data for that year due to data limitation (such as no observations during a period). 
...
# end of each site
write.csv(outcome, 'data/outcome_temp_TA_conversed.csv', row.names = F)
write.csv(outcome_siteyear, 'data/outcome_siteyear_temp_TA_conversed.csv', row.names = F)
