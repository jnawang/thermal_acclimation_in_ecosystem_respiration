# Purpose of this script: prepare for data for fitting temperature-respiration curves for the demonstration site US-Kon. 
...
# put a for loop here
for (file in files_AmeriFlux_BASE) {
  # 
  name_site <- substring(file, 5, 10)
  print(name_site)
...
write.csv(feature_gs, file=file.path(dir_rawdata, 'growing_season_feature_AmeriFlux_1site.csv'), row.names = F)
