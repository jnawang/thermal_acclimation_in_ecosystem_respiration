...
for (i in 51:80) {
  ...
  acclimation$NEE_night_mod_p[iacclimation]  <- df_NEE_p_f$NEE_p[which.max(df_NEE_p_f$ratio)]
  acclimation$NEE_night_mod_f[iacclimation]  <- df_NEE_p_f$NEE_f[which.max(df_NEE_p_f$ratio)]
  #
