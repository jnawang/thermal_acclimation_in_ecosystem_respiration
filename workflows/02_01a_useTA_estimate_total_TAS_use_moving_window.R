...
# end of each site
write.csv(outcome, file = file.path('data', 'outcome_temp_TA.csv'), row.names = F)
write.csv(outcome_siteyear, file = file.path('data', 'outcome_siteyear_temp_TA.csv'), row.names = F)
