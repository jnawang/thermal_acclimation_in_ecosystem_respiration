...
write.csv(outcome, file = file.path('data', 'outcome_temp_water_gpp_old.csv'), row.names = F)
write.csv(outcome_siteyear, file = file.path('data', 'outcome_siteyear_temp_water_gpp_old.csv'), row.names = F)
