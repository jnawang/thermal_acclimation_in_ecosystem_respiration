...
```{r I need to have a function to predict soil temperature--not used for this site}
...
#
# this is super slow
rf <- randomForest(formula = TS_1_1_1 ~ T_SONIC + DOY, data=train)  # this takes lots of time
y0 <- predict(rf, train)
y1 <- predict(rf, test)
